...
public class ScheduledTasks {
    ...
    public void generateDistributionFormTask(){
        ...
        autoGenerateDistributionForm("kexing",todayStr,currentTime);
        //可以继续手工添加

        logger.info("Generate distribution form task end!");
    }

    private void autoGenerateDistributionForm(String center,String todayStr,String currentTime){
        int result = 0;
        long start = System.currentTimeMillis();
        try{
            //todo -- 暂时只自动生成kexing的配送单
            result = distributionFormService.generateDistributionForm(center,todayStr);
        }catch (Exception e){
